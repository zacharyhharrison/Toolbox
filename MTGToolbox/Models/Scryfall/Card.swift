...
struct Card: Codable {
    ...
    let setID, welcomeSet, setName, setType: String
...
struct Legalities: Codable {
    ...
    let oathbreaker, brawl, historicbrawl, alchemy: String
    let paupercommander, duel, oldschool, premodern: String
    let predh: String
}
